    ...
    <section className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="mb-16 text-center">
          <p className="text-sm tracking-widest uppercase text-accent font-bold mb-4">Special Events</p>
          <h2 className="text-4xl md:text-5xl font-bold text-primary tracking-tight text-balance max-w-3xl mx-auto mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {retreatPackages.map((retreat, index) => (
            <div
              key={index}
              className="group bg-muted border-2 border-transparent hover:border-accent transition-all duration-300 hover:shadow-xl p-8"
            >
              <div className="mb-6">
                <p className="text-xs uppercase tracking-wider text-accent font-bold mb-2">{retreat.duration}</p>
                <h3 className="text-2xl font-bold text-primary tracking-tight mb-2">{retreat.title}</h3>
                <p className="text-2xl font-bold text-accent mb-4">
                  {retreat.price} <span className="text-base text-muted-foreground font-normal">{retreat.priceUnit}</span>
                </p>
              </div>

              <p className="text-muted-foreground leading-relaxed mb-6">{retreat.description}</p>
        ...
        <div className="text-center">
          ...
          <Link href="/contact">
            <Button className="px-10 py-4 bg-secondary text-white font-bold text-sm tracking-wide uppercase hover:bg-secondary/90 transition-all hover:scale-105 shadow-lg">
